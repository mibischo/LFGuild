...
var ResultTableComponent = /** @class */ (function () {
    function ResultTableComponent() {
        this.displayedColumns = ['faction', 'name', 'server', 'ilvl', 'specs', 'pveScore', 'mPlusScore', 'battletag', 'guild', 'charlink', 'raidsPerWeek', 'transfer', 'languages', 'timestamp'];
