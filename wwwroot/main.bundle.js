...
var ResultTableComponent = /** @class */ (function () {
    function ResultTableComponent() {
        this.displayedColumns = ['name', 'server', 'ilvl', 'charlink', 'logs', 'timestamp', 'race', 'class', 'battletag', 'languages', 'transfer', 'raidsPerWeek', 'specs', 'pveScore', 'mPlusScore'];
